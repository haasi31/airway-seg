...
from graph_generation import tree2img
...
def csv2nifti(args):
    ...
    volume, segmentation, lumen, lobes = [], [], [], []
    ...
    for lobe_idx in range(1, 6):
        ...
        if config['mode'] == 'airways':
            lumen_, lobe = out_dict['lumen_img'], out_dict['lobe']
            lumen.append(lumen_)
            lobes.append(lobe)
       
    # save the combined lobes  
